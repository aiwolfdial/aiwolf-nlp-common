...
def test_talk_list() -> None:
    value = json.loads(
        """{"talk_history":[{"idx":0,"day":0,"turn":0,"agent":"Agent[05]","text":"1567e6fc799ebd6393180fb64e99681b","skip":false,"over":false},{"idx":1,"day":0,"turn":0,"agent":"Agent[01]","text":"6c97a4a02204110b549d3d176d283392","skip":false,"over":false},{"idx":2,"day":0,"turn":0,"agent":"Agent[03]","text":"abfc69161ca6f4f8123579810037f8ef","skip":false,"over":false}]}""",
    )
    talk_history = (
