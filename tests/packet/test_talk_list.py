...
def test_talk_list() -> None:
    value = json.loads(
        """{"talk_history":[{"idx":0,"day":1,"turn":0,"agent":"ヴィクトリア","text":"866cd7648816a1c51fb0817996400a6c","skip":false,"over":false,"time":1700000000000},{"idx":1,"day":1,"turn":0,"agent":"リュウジ","text":"5ad0c6227b9b5352ef3a824ccdcf509e","skip":false,"over":false,"time":1700000000100},{"idx":2,"day":1,"turn":0,"agent":"セルヴァス","text":"f71e4e6cd69d79794c96900092d75900","skip":false,"over":false,"time":1700000000200}]}""",
    )
    talk_history = (
    ...
    assert talk_history[0].time == 1700000000000
    assert talk_history[2].time == 1700000000200
